...
import { Eye, EyeOff, LogIn, Mail, Shield, Truck, Star, ChevronRight } from "lucide-react";
...
export function SignInClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setError("Invalid email or password. Try signing up if you don&apos;t have an account.");
    }
  };
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mt-20">
              ...
              >
                Your Journey
                <br />
                <span className="text-[#E53935]">Starts Here</span>
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Accessories that define your drive. Sign in to explore premium car accessories curated for every Indian automobile.
              </motion.p>
              ...
              >
                {[
                  ...
                  { icon: Star, text: "4.9★ average rating from 50K+ customers" },
                  { icon: Shield, text: "Premium quality with 1-year warranty" },
                ].map((item, i) => (
          ...
          >
            <div className="flex -space-x-1.5">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-6 h-6 rounded-full border-2 border-[#1A1A1A] bg-white/10 flex items-center justify-center text-[10px] font-medium text-white/60">
                  {String.fromCharCode(64 + i)}
                </div>
              ))}
              <div className="w-6 h-6 rounded-full border-2 border-[#1A1A1A] bg-[#E53935] flex items-center justify-center text-[10px] font-bold text-white">
                10K+
              </div>
            </div>
            <span>Trusted by 50,000+ car owners across India</span>
          </motion.div>
        </motion.div>
        ...
        <div className="flex items-center justify-center p-6 sm:p-8 lg:p-12 xl:p-16 bg-gradient-to-br from-[#F8F8F8] via-white to-[#FFF5F5]">
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-sm text-[#666666] mt-1.5">Sign in to continue your shopping experience</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className={cn(
                      "rounded-xl border-[#ECECEC] bg-[#FAFAFA] focus:bg-white focus:border-[#E53935] transition-all pr-12 h-12 px-4"
                    )}
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-[#ECECEC] text-[#E53935] accent-[#E53935]" />
                  <span className="text-xs text-[#666666]">Remember me</span>
                </label>
                <button type="button" className="text-xs text-[#E53935] font-medium hover:underline">
                  Forgot Password?
                </button>
              </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-4 text-[#999999]">Or continue with</span>
              </div>
            </div>
